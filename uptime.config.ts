...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    { id: 'op2', name: 'op2', method: 'GET', target: 'https://op2tty.boy.pp.ua', tooltip: 'This is a tooltip for this monitor', statusPageLink: 'https://op2tty.boy.pp.ua', expectedCodes: [404], timeout: 10000, headers: {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36',},},
    { id: 't509', name: 't509', method: 'GET', target: 'https://t2e0x1.boy.pp.ua', tooltip: 'This is a tooltip for this monitor', statusPageLink: 'https://t2e0x1.boy.pp.ua', expectedCodes: [401], timeout: 10000, headers: {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36',},},
